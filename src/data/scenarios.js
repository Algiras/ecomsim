...
export const SCENARIOS = {
  ...
  debtSpiral: {
    ...
    description: 'Years of populist spending with low taxes have left the government $30,000 in debt. Creditors are nervous. Austerity or default — pick your poison.',
    icon: '💸',
    difficulty: 'Hard',
    color: '#ef4444',
    isHistorical: false,
